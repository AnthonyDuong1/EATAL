...
It should be notes that EATAL produces advisory output. The trust scores, the queue, the drift alerts, is meant to help a compliance or privacy officer figure out where to look. None of it should ever be used to automatically block access or flag a clinician without a human review first.
